...
def persistent_st():
    return ('Персистентное дерево отрезков\n'
            '\n'
            'Персистентое ДО сохраняет все свои версии (версии появляются в процессе запросов изменения)\n'
            '\n'
            ...
            '   Построим на этом массиве персистентое ДО\n'
            '   Построим на этом массиве персистентое ДО\n'
...
# COMPLETE 6) Персистентое ДО + задачи на него (k-ая порядковая статистика, кол-во различных...)
