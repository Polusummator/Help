...
def graphs():
    return ('КОНДЕНСАЦИЯ\n'
            ...
            '\n'
            'ПОЛНЫЙ КОД КОНДЕНСАЦИИ (ПОСТРОЕНИЕ НОВОГО ГРАФА ИЗ КОМПОНЕНТ СИЛЬНОЙ СВЯЗНОСТИ) +\n'
            'ЗАДАЧА О МАКСИМАЛЬНОМ ДОСТИЖИМОМ ЧИСЛЕ ДЛЯ КАЖДОЙ ВЕРШИНЫ\n'
            'int n, m;\n'
            'vector<vector<int>> g;\n'
            'vector<int> used;\n'
            'vector<int> ts;\n'
            ...
            '}\n'
            '\n'
            'АЛГОРИТМ ДЕЙКСТРЫ см. раздел Dijkstra (а ещё graphs2)\n'
            '\n'
            '!!!!! GRAPHS2 !!!!!\n'
            'Раздел graphs2 - продолжение и дополнение graphs\n'
            'В нём описаны:\n'
            '1. Ускоренный алгоритм Дейкстры (с set)\n'
            '2. Алгоритм Флойда\n'
            '3. Алгоритм Форда-Беллмана\n'
            '4. Остовные деревья (полная версия)\n')
...
def graphs2():
    return ('Графы. Часть 2\n'
            ...
            '\n'
            'ОСТОВНЫЕ ДЕРЕВЬЯ\n'
            'Что такое остовное дерево, можно прочесть в разделе graphs\n'
            '\n'
            'Алгоритм Прима:\n'
...
def Kuhn():
    return ('Алгоритм Куна\n'
            '\n'
            'Алгоритм Куна - это алгоритм посика максимального по размеру паросочетания в двудольном графе\n'
            '\n'
...
def no(a):
    ...
    # 5) структуры данных
    # 6) алгоритмы, которые не структуры данных (lca, например)
...
#             'sqrt_decomposition', 'Mo', 'Huffman', 'graphs2', 'trie', 'geometry', 'convex_hull', 'treap',
#             'implicit_treap', 'mergesort_tree', 'Fenwick', 'segment_tree_2Dproblems', 'lca', 'maxmatch', 'Kuhn',
#             'prefix_function', 'bridges_cutpoints']
...
# TODO: SECTIONS REVOLUTION: выстроить всё в нормальном порядке
# TODO: SECTIONS REVOLUTION: разделить graphs, graphs2 (Dijkstra выкинуть, если это медленная версия)
...
# TODO: 2) Эйлеров путь, Эйлеров цикл + приколы (покрытие путями, например)
...
# TODO: 6) Персистентое ДО + задачи на него (k-ая порядковая статистика, кол-во различных...)
# TODO: 7) Приколы с рюкзаком, разные дп (например, гамильтонов путь) + дп по поддеревьям тоже
# TODO: 7.5) Convex Hull Trick, матричная оптимизация + расстояние Левенштейна напиши ты уже
# COMPLETE 8) МОСТЫ ПЕРЕДЕЛАТЬ!!!!! + точки сочленения, компоненты вершинной двусвязности
# TODO: 9) 2-SAT
# TODO: 10) Комбинаторику надо написать (а сначала узнать)
# TODO: ~11) Мб, переделать отрицательный цикл
# TODO: ~12) Можно изучить лестничную декомпозицию (не, не надо)
# TODO: ~13) Можно изучить HLD (не, не надо)
