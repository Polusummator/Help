...
def graphs2():
    return ('Графы. Часть 2\n'
            ...
            'cout << dp[s][f] << el;\n'
            '\n'
            'АЛГОРИТМ ДЕЙКСТРЫ (быстрая версия)\n'
            ...
            'Такой способ будет работать быстрее (кроме случая с полными графами)\n'
            'int n, start, finish;\n'
            'cin >> n >> start >> finish;\n'
            'start--;\n'
            'finish--;\n'
...
# TODO: 1) приколы с парсочем (вершинное покрытие, покрытие путями...)
...
# TODO: 7.5) Convex Hull Trick, матричная оптимизация
# TODO: 8) МОСТЫ ПЕРЕДЕЛАТЬ!!!!! + точки сочленения, компоненты вершинной двусвязности
# TODO: 9) 2-SAT
