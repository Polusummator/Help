...
def hashes():
    return ('Хэши\n'
            ...
            '\n'
            'Но, т.к. данный хэш неидеален, можно делать двойной, тройной и т.д. хэш (делать к одной строке несколько хэшей с разными p и mod)\n'
            '\n'
...
def segment_tree():
    return ('Дерево отрезков\n'
            ...
            '\n'
            'Используя дерево отрезков, можно построить дерево хэшей и делать операции с хэшами, имея возможность изменять элементы строки\n'
